...
namespace RealEstateAgency.Controllers.Estate
{
    public partial class PropertyController : ModelPagingController<Property, PropertyDto, PropertyPaginationListDto>
    {
        ...
        private readonly IEntityService<SharedProperty> _sharedPropertyService;
        private readonly IEntityService<SharedPropertyClick> _sharedPropertyClickService;
        private readonly ISocialNetworkProvider _networkProvider;

        public PropertyController(IModelService<Property, PropertyDto> modelService,
            IUserProvider userProvider, IPathProvider pathProvider,
            IEntityService<SharedProperty> sharedPropertyService,
            IEntityService<SharedPropertyClick> sharedPropertyClickService,
            ISocialNetworkProvider networkProvider) : base(modelService)
        {
            _userProvider = userProvider;
            _pathProvider = pathProvider;
            _sharedPropertyService = sharedPropertyService;
            _sharedPropertyClickService = sharedPropertyClickService;
        ...
        public override Task<ActionResult<PropertyDto>> Create(PropertyDto value, CancellationToken cancellationToken)
        {
            value.AgentId = _userProvider.AgentId;
